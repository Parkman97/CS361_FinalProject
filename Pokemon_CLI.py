    ...
    while programRunning:
        ...
        while main_input != 10:
            if main_input == 1:
                ...
                main_input = value[0]
                pokemonName = value[1]
                pokemonDictionary = value[2]

            elif main_input == 2:
                main_input = searchPokemonMenu()

            elif main_input == 3:
                if pokemonDictionary != None and pokemonName != None:
                    main_input = displayPokemonName(pokemonName, pokemonDictionary)
                    pokemonDictionary = None
                    pokemonName = None
                else:
